                  ...
                  <table class="table align-items-center table-flush">
                    ...
                    <tbody>
                      <tr v-for="cart in carts" :key="cart.id">
                        ...
                        <td><a @click="removeItem(cart.id)" class="btn btn-sm btn-primary" style="border-radius:25px;"><font color="ffffff">X</font></a></td>
                      </tr>
...
<div class="card-body">
                     <input type="text" v-model="searchTerm" class="form-control" style="width:560px" placeholder="Search Product"><br> 
  ...
  <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
      <input type="text" v-model="getsearchTerm" class="form-control" style="width:560px" placeholder="Search Product"><br> 
       <div class="row">
